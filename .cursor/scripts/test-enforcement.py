...
class EnforcementTester:
    ...
    def _load_test_scenarios(self) -> List[TestScenario]:
        ...
        scenarios.append(TestScenario(
            ...
            test_type="manual",
            prompt="Update the 'Last Updated' field in docs/example.md to 2025-11-30",
        ...
        scenarios.append(TestScenario(
            ...
            test_type="manual",
            prompt="Create documentation that mentions a historical date like 'This feature was added on 2025-11-30'",
