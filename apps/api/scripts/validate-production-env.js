...
function main() {
    ...
    for (const envVar of requiredEnvVars) {
        ...
        if (result.valid) {
            const displayValue = envVar.name.includes('SECRET') || envVar.name.includes('KEY')
                ? '***' + (value === null || value === void 0 ? void 0 : value.slice(-4))
                : value;
    ...
    for (const pattern of devPatterns) {
        if (envString.toLowerCase().includes(pattern) &&
            (((_a = process.env.SUPABASE_URL) === null || _a === void 0 ? void 0 : _a.includes(pattern)) ||
                ((_b = process.env.ALLOWED_ORIGINS) === null || _b === void 0 ? void 0 : _b.includes(pattern)))) {
