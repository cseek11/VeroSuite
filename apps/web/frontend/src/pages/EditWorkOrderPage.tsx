...
export default function EditWorkOrderPage() {
  ...
  const initialData: UpdateWorkOrderRequest = {
    ...
    ...(workOrder.completion_date !== undefined && { completion_date: workOrder.completion_date }),
    description: workOrder.description,
    ...(workOrder.notes !== undefined && { notes: workOrder.notes }),
    ...(workOrder.service_type !== undefined && { service_type: workOrder.service_type }),
    ...(workOrder.estimated_duration !== undefined && { estimated_duration: workOrder.estimated_duration }),
