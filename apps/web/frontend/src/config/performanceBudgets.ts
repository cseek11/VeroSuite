...
export interface PerformanceBudget {
  metric: string;
  target: number; // Target value in milliseconds or score
  warning: number; // Warning threshold
  error: number; // Error threshold (fails CI)
...
export interface PerformanceBudgets {
  // Core Web Vitals
  webVitals: {
    FCP: PerformanceBudget; // First Contentful Paint
    LCP: PerformanceBudget; // Largest Contentful Paint
    FID: PerformanceBudget; // First Input Delay
    CLS: PerformanceBudget; // Cumulative Layout Shift
    TTFB: PerformanceBudget; // Time to First Byte
  };
  
  // Dashboard Performance
  dashboard: {
    loadTime: PerformanceBudget;
    cardInteraction: PerformanceBudget;
    listRendering: PerformanceBudget;
    cardDragStart: PerformanceBudget;
    cardResize: PerformanceBudget;
  };
  
  // API Performance
  api: {
    responseTime: PerformanceBudget;
    slowQuery: PerformanceBudget;
    errorRate: PerformanceBudget;
  };
  
  // Resource Performance
  resources: {
    bundleSize: PerformanceBudget;
    imageSize: PerformanceBudget;
    fontSize: PerformanceBudget;
    totalSize: PerformanceBudget;
  };
  
  // Mobile Performance
  mobile: {
    loadTime3G: PerformanceBudget;
    loadTime4G: PerformanceBudget;
    interactionDelay: PerformanceBudget;
 ...
 */
export const performanceBudgets: PerformanceBudgets = {
 ...
 */
export function formatBudgetValue(value: number, unit: string): string {
  switch (unit) {
    case 'ms':
