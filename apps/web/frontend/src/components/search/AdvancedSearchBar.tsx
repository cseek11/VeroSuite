...
import type { AdvancedSearchResult } from '@/lib/advanced-search-service';
...
export const AdvancedSearchBar: React.FC<AdvancedSearchBarProps> = ({
  ...
  const stableOnResultsChange = useCallback((newResults: AdvancedSearchResult[]) => {
    if (onResultsChange) {
          ...
          <div className="flex-1 relative">
            <div className="relative">
              ...
              <input
                ...
                onBlur={(_event: React.FocusEvent<HTMLInputElement>) => setIsFocused(false)}
