...
type DashboardTestCategory = TestCategory & { icon?: React.ReactNode };

// Remove duplicate interfaces since they're imported from the service

const TestingDashboard: React.FC = () => {
  const [categories, setCategories] = useState<DashboardTestCategory[]>([
    {
      id: 'unit',
      name: 'Unit Tests',
  ...
  const handleTestCategoryCompleted = (categoryId: string, _output: string) => {
