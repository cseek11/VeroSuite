                      ...
                      <td key={resource} className="px-4 py-3 whitespace-nowrap">
                        {hasAll ? (
                          ...
                          <div className="flex items-center space-x-2">
                            {canView && <CheckCircle className="h-4 w-4 text-blue-500" />}
                            {canEdit && <CheckCircle className="h-4 w-4 text-yellow-500" />}
                            {canDelete && <CheckCircle className="h-4 w-4 text-red-500" />}
