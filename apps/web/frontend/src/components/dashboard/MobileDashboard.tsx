  ...
  return (
    <div className={`mobile-dashboard ${className}`}>
      ...
      <div
        ...
        style={deviceStyles}
        onTouchStart={(e: React.TouchEvent) => handleTouchStart(e.nativeEvent as TouchEvent)}
        onTouchMove={(e: React.TouchEvent) => handleTouchMove(e.nativeEvent as TouchEvent)}
        onTouchEnd={(e: React.TouchEvent) => handleTouchEnd(e.nativeEvent as TouchEvent)}
        onTouchCancel={(e: React.TouchEvent) => handleTouchCancel(e.nativeEvent as TouchEvent)}
        onMouseDown={(e) => {
