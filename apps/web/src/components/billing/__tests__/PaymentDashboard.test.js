...
var PaymentDashboard_1 = __importDefault(require("../PaymentDashboard"));
...
vitest_1.vi.mock('@/lib/enhanced-api', function () { return ({
    billing: {
        ...
        getPaymentAnalytics: vitest_1.vi.fn(),
...
(0, vitest_1.describe)('PaymentDashboard', function () {
    var queryClient;
    ...
    var renderComponent = function () {
        return (0, react_1.render)((0, jsx_runtime_1.jsx)(react_query_1.QueryClientProvider, { client: queryClient, children: (0, jsx_runtime_1.jsx)(PaymentDashboard_1.default, {}) }));
    };
    ...
    (0, vitest_1.describe)('Component Rendering', function () {
        (0, vitest_1.it)('should render loading state', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                mockBilling.getPaymentAnalytics.mockImplementation(function () { return new Promise(function () { }); });
                mockBilling.getARSummary.mockImplementation(function () { return new Promise(function () { }); });
                renderComponent();
                (0, vitest_1.expect)(react_1.screen.getByText(/loading payment dashboard/i)).toBeInTheDocument();
                return [2 /*return*/];
            });
        }); });
        (0, vitest_1.it)('should render dashboard with data', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(react_1.screen.getByText(/payment dashboard/i)).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(react_1.screen.getByText(/comprehensive payment metrics and analytics overview/i)).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        renderComponent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(react_1.screen.getByText(/total payments/i)).toBeInTheDocument();
                                (0, vitest_1.expect)(react_1.screen.getByText(/average payment/i)).toBeInTheDocument();
                                (0, vitest_1.expect)(react_1.screen.getByText(/success rate/i)).toBeInTheDocument();
                                (0, vitest_1.expect)(react_1.screen.getByText(/total ar/i)).toBeInTheDocument();
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    (0, vitest_1.describe)('Error Handling', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        renderComponent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith('Failed to fetch payment tracking data', error, 'PaymentDashboard');
                                (0, vitest_1.expect)(mockToast.error).toHaveBeenCalled();
                            })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(react_1.screen.getByText(/failed to load payment dashboard data/i)).toBeInTheDocument();
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
        ...
        (0, vitest_1.it)('should handle payment analytics error', function () { return __awaiter(void 0, void 0, void 0, function () {
            var error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        renderComponent();
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith('Failed to fetch payment analytics', error, 'PaymentDashboard');
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    (0, vitest_1.describe)('CSV Export', function () {
        ...
        (0, vitest_1.it)('should export CSV successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockClick, mockAppendChild, mockRemoveChild, exportButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        mockAppendChild = vitest_1.vi.fn();
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(mockLogger.debug).toHaveBeenCalledWith('Payment Dashboard CSV exported', vitest_1.expect.any(Object), 'PaymentDashboard');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        react_1.fireEvent.click(exportButton);
                        return [4 /*yield*/, (0, react_1.waitFor)(function () {
                                (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith('Failed to export Payment Dashboard CSV', vitest_1.expect.any(Error), 'PaymentDashboard');
                                (0, vitest_1.expect)(mockToast.error).toHaveBeenCalled();
                            })];
                    case 2:
                        _a.sent();
    ...
    (0, vitest_1.describe)('Date Range Filtering', function () {
        ...
        (0, vitest_1.it)('should update date range and refetch data', function () { return __awaiter(void 0, void 0, void 0, function () {
            var dateInputs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        dateInputs = react_1.screen.getAllByDisplayValue('');
                        (0, vitest_1.expect)(dateInputs.length).toBeGreaterThan(0);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, vitest_1.expect)(react_1.screen.getByText(/comprehensive payment metrics/i)).toBeInTheDocument();
                        return [2 /*return*/];
                }
            });
        }); });
