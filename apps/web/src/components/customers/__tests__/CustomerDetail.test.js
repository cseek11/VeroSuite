...
var CustomerDetail_1 = __importDefault(require("../CustomerDetail"));
// Mock Supabase
...
(0, vitest_1.describe)('CustomerDetail', function () {
    var mockOnBack = vitest_1.vi.fn();
    var mockOnEdit = vitest_1.vi.fn();
    (0, vitest_1.beforeEach)(function () {
        vitest_1.vi.clearAllMocks();
    });
    (0, vitest_1.describe)('Rendering', function () {
        (0, vitest_1.it)('should render customer details', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, react_1.render)((0, jsx_runtime_1.jsx)(TestWrapper, { children: (0, jsx_runtime_1.jsx)(CustomerDetail_1.default, { customerId: "account-1", onBack: mockOnBack, onEdit: mockOnEdit }) }));
        ...
        (0, vitest_1.it)('should show loading state', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('@/lib/supabase-client')); })];
                    case 1:
                        supabase = (_a.sent()).supabase;
                        supabase.from.mockReturnValue({
                            select: vitest_1.vi.fn().mockReturnThis(),
                            eq: vitest_1.vi.fn().mockReturnThis(),
                            single: vitest_1.vi.fn().mockImplementation(function () { return new Promise(function () { }); } // Never resolves
                            ),
                        });
                        (0, react_1.render)((0, jsx_runtime_1.jsx)(TestWrapper, { children: (0, jsx_runtime_1.jsx)(CustomerDetail_1.default, { customerId: "account-1", onBack: mockOnBack, onEdit: mockOnEdit }) }));
    ...
    (0, vitest_1.describe)('Actions', function () {
        (0, vitest_1.it)('should call onBack when back button is clicked', function () { return __awaiter(void 0, void 0, void 0, function () {
            var backButton;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        backButton = react_1.screen.getByRole('button', { name: /back|arrow/i });
                        react_1.fireEvent.click(backButton);
                        (0, vitest_1.expect)(mockOnBack).toHaveBeenCalled();
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, vitest_1.expect)(mockOnEdit).toHaveBeenCalled();
                        return [2 /*return*/];
                }
            });
        }); });
