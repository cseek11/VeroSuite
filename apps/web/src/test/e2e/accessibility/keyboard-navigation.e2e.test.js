...
test_1.test.describe('Keyboard Navigation E2E', function () {
    ...
    (0, test_1.test)('should navigate with Tab key', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var focusedElement;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
    ...
    (0, test_1.test)('should submit form with Enter key', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var createButton, descriptionInput;
        var page = _b.page;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, page.goto('/work-orders')];
                ...
                case 7:
                    _c.sent();
                    return [4 /*yield*/, descriptionInput.press('Enter')];
                case 8:
                    _c.sent();
                    _c.label = 9;
