...
test_1.test.describe('Authentication Flow E2E', function () {
    (0, test_1.test)('should login successfully', function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, emailInput.isVisible()];
                case 3:
                    if (!_c.sent()) return [3 /*break*/, 8];
                    return [4 /*yield*/, emailInput.fill('test@example.com')];
                case 4:
                    _c.sent();
                    return [4 /*yield*/, passwordInput.fill('password123')];
                case 5:
                    _c.sent();
                ...
                case 6:
                    ...
                    return [4 /*yield*/, page.waitForURL(/dashboard|home/, { timeout: 10000 })];
                case 7:
                    // Wait for redirect or success message
                    _c.sent();
                    _c.label = 8;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, logoutButton.isVisible()];
                case 3:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, page.waitForURL(/login/, { timeout: 5000 })];
                case 5:
                    // Should redirect to login
                    _c.sent();
                    _c.label = 6;
