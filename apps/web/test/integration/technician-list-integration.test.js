...
(0, vitest_1.describe)('Technician List Integration', function () {
    var mockTechnicians = [
    ...
    (0, vitest_1.it)('should fetch technicians from API and display in dropdown', function () { return __awaiter(void 0, void 0, void 0, function () {
        var technicianSelect;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    (0, react_1.render)((0, jsx_runtime_1.jsx)(TestWrapper, { children: (0, jsx_runtime_1.jsx)(WorkOrderForm_1.default, { onSubmit: vitest_1.vi.fn(), onCancel: vitest_1.vi.fn() }) }));
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, react_1.waitFor)(function () {
                            (0, vitest_1.expect)(react_1.screen.getByText(/john doe/i)).toBeInTheDocument();
