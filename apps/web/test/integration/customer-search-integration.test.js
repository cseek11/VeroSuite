...
(0, vitest_1.describe)('Customer Search Integration', function () {
    ...
    (0, vitest_1.it)('should fetch customers from API and display in search', function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockOnChange, searchInput;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockOnChange = vitest_1.vi.fn();
                ...
                case 1:
                    _a.sent();
                    searchInput = react_1.screen.getByPlaceholderText(/search customers/i);
    ...
    (0, vitest_1.it)('should call onChange when customer is selected', function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockOnChange, searchInput, customerOption;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockOnChange = vitest_1.vi.fn();
