...
exports.HTMLDashboardGenerator = void 0;
const fs = require("fs");
...
class HTMLDashboardGenerator {
    ...
    async collectReports() {
        ...
        this.dashboardData.complianceScore = 95;
    }
    analyzeReports() {
    ...
    generateHtmlReport() {
        const { overallHealthScore, securityPosture, performanceTrends, testCoverage, recentFailures, vulnerabilityCount, complianceScore, flakyTests, lastUpdated, } = this.dashboardData;
...
<head>
    ...
    <title>VeroField Enterprise Testing Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 VeroField Enterprise Testing Dashboard</h1>
        ...
        <div class="footer">
            <p>Generated by VeroField Enterprise Testing Framework</p>
    ...
    async generateAndSaveDashboard(filename = 'testing-dashboard.html') {
...
exports.HTMLDashboardGenerator = HTMLDashboardGenerator;
...
//# sourceMappingURL=html-dashboard-generator.js.map