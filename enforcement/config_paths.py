...
def get_project_root() -> Path:
    ...
    # If we're in .cursor__disabled/enforcement/, go up 3 levels (legacy)
    # Check both possibilities
    possible_roots = [
        current.parent.parent,  # enforcement/config_paths.py -> root (canonical)
        current.parent.parent.parent,  # .cursor__disabled/enforcement/config_paths.py -> root (legacy)
    ]
    ...
    # Fallback: assume we're in enforcement/ at root and go up 1 level
