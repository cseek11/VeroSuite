...
### Work Order → Job Relationship (Enterprise CRM Pattern)

The relationship between Work Orders and Jobs follows the standard enterprise CRM workflow pattern:
...
**Work Order** = The requirement/request for work to be done
...
**Job** = The scheduled appointment/execution of work
