...
✅ Check component library catalog (COMPONENT_LIBRARY_CATALOG.md)
...
```
✅ Read DEVELOPMENT_BEST_PRACTICES.md
✅ Review CRM_STYLING_GUIDE.md
...
read_file("DEVELOPMENT_BEST_PRACTICES.md")
read_file("COMPONENT_LIBRARY_CATALOG.md")
...
### For AI Assistants
1. **Start Here**: DEVELOPMENT_BEST_PRACTICES.md
2. **Component Reference**: COMPONENT_LIBRARY_CATALOG.md
3. **Styling Guide**: CRM_STYLING_GUIDE.md
4. **Design System**: DESIGN_SYSTEM.md
5. **AI Best Practices**: AI_ASSISTANT_BEST_PRACTICES.md
