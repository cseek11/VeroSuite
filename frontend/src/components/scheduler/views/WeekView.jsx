  ...
  return (
    <div className="grid grid-cols-8 h-full overflow-auto">
      <div className="col-span-1 bg-gray-50 border-r border-gray-200">
        <div className="p-2 border-b border-gray-200 bg-gray-100 font-medium text-gray-700 text-xs">Time</div>
      ...
      {days.map((d, i) => (
        <div key={i} className="col-span-1 border-r border-gray-200">
          <div className="p-2 border-b border-gray-200 bg-gray-50 font-medium text-gray-700 text-center">
