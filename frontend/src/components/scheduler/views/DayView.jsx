...
export default function DayView({ events, onEdit, resources }) {
  ...
  return (
    <div className="day-view h-full flex flex-col overflow-hidden">
      <div className="text-center text-lg font-semibold p-2 text-gray-800 border-b border-gray-200 bg-gray-50/50 flex-shrink-0">
        Day View
      </div>
      <div className="flex-1 overflow-auto">
        <div className="relative border border-gray-200 rounded-lg overflow-hidden" style={{ minHeight: 24 * 40 }}>
          {hours.map(hour => (
            <div key={hour} className="border-b border-gray-200 bg-gray-50/50" style={{ height: 40 }}>
