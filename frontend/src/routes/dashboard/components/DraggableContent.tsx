...
interface DraggableContentProps {
  cardId: string;
  dataType: DataType;
  data: Record<string, unknown> & { id?: string; _id?: string; name?: string; title?: string };
  selectedItems?: Array<Record<string, unknown>>; // For multi-select
  children: React.ReactNode;
  className?: string;
  disabled?: boolean;
  onDragStart?: (payload: DragPayload) => void;
  getDragPreview?: (data: Record<string, unknown>, selectedItems?: Array<Record<string, unknown>>) => {
    title: string;
    icon?: string;
    color?: string;
    count?: number;
