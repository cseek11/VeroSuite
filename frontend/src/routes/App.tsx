...
const VeroCardsV3 = lazy(() => import('./VeroCardsV3'));
const RegionDashboardPage = lazy(() => import('./dashboard/RegionDashboardPage'));
const CommunicationsPage = lazy(() => import('./Communications'));
...
const UploadsPage = lazy(() => import('./Uploads'));
...
const EditWorkOrderPage = lazy(() => import('@/pages/EditWorkOrderPage'));
const CustomerPage = lazy(() => import('@/components/CustomerPage'));
const TechniciansPage = lazy(() => import('@/pages/TechniciansPage'));
const CreateTechnicianPage = lazy(() => import('@/pages/CreateTechnicianPage'));
const EditTechnicianPage = lazy(() => import('@/pages/EditTechnicianPage'));
const TechnicianDetailPage = lazy(() => import('@/pages/TechnicianDetailPage'));
const SearchAnalyticsDashboard = lazy(() => import('@/components/analytics/SearchAnalyticsDashboard'));
const CustomerManagement = lazy(() => import('@/pages/CustomerManagement'));
const ServiceManagement = lazy(() => import('@/pages/ServiceManagement'));
const AgreementsPage = lazy(() => import('@/pages/AgreementsPage'));
const CreateAgreementPage = lazy(() => import('@/pages/CreateAgreementPage'));
