...
describe('API Clients Integration', () => {
  ...
  describe('enhancedApi.technicians.list()', () => {
    ...
    it('should return empty array when no technicians found', async () => {
      ...
      const result = await enhancedApi.technicians.list();
      // The mock in setup.ts returns { technicians: [], ... }, so check for that structure
      expect(Array.isArray(result) || (result && Array.isArray(result.technicians))).toBe(true);
    });
  });
  ...
  describe('secureApiClient.getAllAccounts()', () => {
    ...
    it('should include authentication headers in request', async () => {
      ...
      const { secureApiClient: realSecureApiClient } = await import('@/lib/secure-api-client');
  ...
  describe('enhancedApi.accounts.search()', () => {
    it('should search accounts by query string', async () => {
      ...
      const result = await enhancedApi.accounts.search('John');
    ...
    it('should handle empty search results', async () => {
      ...
      const result = await enhancedApi.accounts.search('NonExistent');
    ...
    it('should handle search API errors', async () => {
      ...
      try {
        await enhancedApi.accounts.search('test');
      } catch (error) {
        expect(error).toBeDefined();
      }
    });
