-- ============================================================================
-- COMPLETE FIX WITH SCHEMA UPDATE - Resolve All Remaining Issues
-- ============================================================================
-- This script fixes the function overload conflicts and database schema issues

-- ============================================================================
-- STEP 1: DROP ALL EXISTING FUNCTIONS (ALL VERSIONS)
-- ============================================================================

-- Drop all possible versions of search functions
...
DROP FUNCTION IF EXISTS search_customers_enhanced(UUID, TEXT, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS search_customers_enhanced(TEXT, UUID, INTEGER);
...
DROP FUNCTION IF EXISTS search_customers_multi_word(UUID, TEXT, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS search_customers_multi_word(TEXT, UUID, INTEGER);
DROP FUNCTION IF EXISTS search_customers_fuzzy(UUID, TEXT, REAL, INTEGER);
DROP FUNCTION IF EXISTS search_customers_fuzzy(TEXT, UUID, REAL, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS search_customers_fuzzy(UUID, TEXT, REAL, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS search_customers_fuzzy(TEXT, UUID, REAL, INTEGER);
DROP FUNCTION IF EXISTS log_search_error(TEXT, TEXT, TEXT, TEXT, TEXT, JSONB);

-- ============================================================================
-- STEP 2: UPDATE SEARCH_ERRORS TABLE SCHEMA
-- ============================================================================

-- Add missing columns to search_errors table
ALTER TABLE search_errors 
...
-- ============================================================================
-- STEP 4: CREATE ENHANCED SEARCH FUNCTION (SINGLE VERSION)
-- ============================================================================
...
-- ============================================================================
-- STEP 5: CREATE MULTI-WORD SEARCH FUNCTION (SINGLE VERSION)
-- ============================================================================
...
-- ============================================================================
-- STEP 6: CREATE FUZZY SEARCH FUNCTION (SINGLE VERSION)
-- ============================================================================
...
BEGIN
    RAISE NOTICE '============================================================================';
    RAISE NOTICE 'COMPLETE FIX DEPLOYED SUCCESSFULLY';
    RAISE NOTICE '============================================================================';
    RAISE NOTICE '✅ All function overloads removed';
