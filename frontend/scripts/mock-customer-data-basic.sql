-- ============================================================================
-- BASIC MOCK CUSTOMER DATA FOR TESTING
-- ============================================================================
...
((SELECT id FROM accounts WHERE name = 'John Smith' LIMIT 1), 'Customer called about increased ant activity in kitchen. Scheduled follow-up inspection.', 'service', 'Tech Support', '7193113e-ece2-4f7b-ae8c-176df4367e28'),
((SELECT id FROM accounts WHERE name = 'John Smith' LIMIT 1), 'Dogs will be in backyard during service. Please use pet-safe products.', 'preference', 'Customer Service', '7193113e-ece2-4f7b-ae8c-176df4367e28'),
((SELECT id FROM accounts WHERE name = 'Sarah Johnson' LIMIT 1), 'Customer has severe chemical allergies. Use only organic, fragrance-free products.', 'preference', 'Manager', '7193113e-ece2-4f7b-ae8c-176df4367e28');
...
((SELECT id FROM accounts WHERE name = 'John Smith' LIMIT 1), 'General Pest Control', '2024-01-15', 'Alex Johnson', 'Applied perimeter treatment. No issues found.', 150.00, 'completed', '7193113e-ece2-4f7b-ae8c-176df4367e28'),
((SELECT id FROM accounts WHERE name = 'John Smith' LIMIT 1), 'Ant Treatment', '2023-10-15', 'Sarah Wilson', 'Targeted ant treatment in kitchen area.', 120.00, 'completed', '7193113e-ece2-4f7b-ae8c-176df4367e28'),
((SELECT id FROM accounts WHERE name = 'Sarah Johnson' LIMIT 1), 'Organic Pest Control', '2024-02-15', 'Mike Chen', 'Used organic products only. Customer satisfied.', 180.00, 'completed', '7193113e-ece2-4f7b-ae8c-176df4367e28');
