...
test_r18_w01_api_performance_regression_detected if {
    result := quality.warn with input as {
        ...
        "performance_baseline": {
            "/api/users": {"p50": 150, "p95": 250, "p99": 300}
        },
        "performance_current": {
            "/api/users": {"p50": 180, "p95": 300, "p99": 400}
        }
    }
...
test_r18_w01_no_regression_if_improved if {
    result := quality.warn with input as {
        ...
        "performance_baseline": {
            "/api/users": {"p50": 200, "p95": 300, "p99": 400}
        },
        "performance_current": {
            "/api/users": {"p50": 180, "p95": 280, "p99": 350}
        }
    }
...
test_r18_w01_no_regression_if_minor_degradation if {
    result := quality.warn with input as {
        ...
        "performance_current": {
            "/api/users": {"p50": 160, "p95": 270, "p99": 320}
        }
    }
...
test_r18_w02_no_warning_if_exemption_exists if {
    result := quality.warn with input as {
        ...
        "performance_current": {
            "/api/reports": {"p50": 600, "p95": 800, "p99": 1000}
        },
        "performance_budgets": {
            "api": {
                "heavy_operations": 500
            }
        },
        "performance_exemptions": [
            {
...
test_r18_w03_frontend_exceeds_fcp_budget if {
    result := quality.warn with input as {
        ...
        "performance_current": {
            "/dashboard": {"fcp": 2.1, "lcp": 1.8, "tti": 2.5}
        },
        "performance_budgets": {
            "frontend": {
                "fcp": 1.5,
...
test_r18_w03_no_warning_if_within_budget if {
    result := quality.warn with input as {
        ...
        "performance_current": {
            "/dashboard": {"fcp": 1.2, "lcp": 1.8, "tti": 2.5}
        },
        "performance_budgets": {
            "frontend": {
                "fcp": 1.5,
...
test_r18_w08_no_warning_if_tracked if {
    result := quality.warn with input as {
        ...
        "performance_history": {
            "/api/users": [
                {"date": "2025-11-01", "p50": 150},
                {"date": "2025-11-23", "p50": 160}
            ]
        }
    }
...
test_r18_w10_critical_endpoint_degradation if {
    result := quality.warn with input as {
        ...
        "performance_baseline": {
            "/api/auth/login": {"p50": 200, "p95": 300, "p99": 400}
        },
        "performance_current": {
            "/api/auth/login": {"p50": 250, "p95": 400, "p99": 500}
        }
    }
...
test_r18_w10_no_warning_if_minor_degradation if {
    result := quality.warn with input as {
        ...
        "performance_current": {
            "/api/auth/login": {"p50": 220, "p95": 330, "p99": 440}
        }
    }
...
test_r18_edge_case_missing_baseline if {
    result := quality.warn with input as {
        ...
        "performance_current": {
            "/api/new-endpoint": {"p50": 180, "p95": 280, "p99": 380}
        }
    }
