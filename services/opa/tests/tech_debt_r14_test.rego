...
test_deferred_fix_logged_as_debt if {
	mock_input := {"changed_files": [
		...
		{
			"path": "docs/tech-debt.md",
			"diff": "## 2025-11-30 - Validation Fix Deferred\n**Category:** Code Quality",
		},
	]}
...
test_complete_remediation_plan if {
	mock_input := {"changed_files": [{
		"path": "docs/tech-debt.md",
		"diff": "## 2025-11-30 - Performance Issue\n**Remediation Plan:**\n1. Step 1\n2. Step 2\n**Estimated Effort:** 2 hours\n**Priority:** High",
	}]}
...
test_missing_debt_entry_for_workaround if {
	...
	warning := [msg | msg := tech_debt.warn[_]][0]
...
test_todos_for_current_pr_with_debt_update if {
	mock_input := {"changed_files": [
		...
		{
			"path": "docs/tech-debt.md",
			"diff": "## 2025-11-30 - Feature Validation\n**Category:** Code Quality",
		},
	]}
