...
test_r17_no_violations if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/user.service.ts", "status": "modified"}],
		"coverage_baseline": {"src/user.service.ts": 85},
		"coverage_current": {"src/user.service.ts": 87},
		"coverage_targets": {"src/user.service.ts": 80},
		"coverage_exemptions": [],
		"coverage_gaps": [],
		"coverage_history": {"src/user.service.ts": [
			{"date": "2025-11-30", "coverage": {"statements": 85}},
			{"date": "2025-11-30", "coverage": {"statements": 87}},
		]},
...
test_r17_w01_coverage_degradation if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/payment.service.ts", "status": "modified"}],
		"coverage_baseline": {"src/payment.service.ts": 90},
		"coverage_current": {"src/payment.service.ts": 80},
		"coverage_targets": {},
		"coverage_exemptions": [],
		"coverage_gaps": [],
		"coverage_history": {},
...
test_r17_w05_below_target_no_exemption if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/auth.service.ts", "status": "modified"}],
		"coverage_baseline": {},
		"coverage_current": {"src/auth.service.ts": 75},
		"coverage_targets": {"src/auth.service.ts": 90},
		"coverage_exemptions": [],
		"coverage_gaps": [],
		"coverage_history": {},
		"coverage_report_generated": true,
...
test_r17_w07_trend_not_tracked if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/new.service.ts", "status": "modified"}],
		"coverage_baseline": {},
		"coverage_current": {},
		"coverage_targets": {},
		"coverage_exemptions": [],
...
test_r17_exemption_suppresses_warning if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/legacy.service.ts", "status": "modified"}],
		"coverage_baseline": {},
		"coverage_current": {"src/legacy.service.ts": 50},
		"coverage_targets": {"src/legacy.service.ts": 80},
		"coverage_exemptions": [{
			"file": "src/legacy.service.ts",
			"coverage": "50%",
			"justification": "Legacy code",
...
test_r17_multiple_violations if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/user.service.ts", "status": "modified"}],
		"coverage_baseline": {"src/user.service.ts": 90},
		"coverage_current": {"src/user.service.ts": 80},
		"coverage_targets": {"src/user.service.ts": 85},
		"coverage_exemptions": [{
			"file": "src/legacy.service.ts",
			"coverage": "40%",
			"expiration": "2025-01-01T00:00:00Z",
...
test_r17_coverage_improvement if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/improved.service.ts", "status": "modified"}],
		"coverage_baseline": {"src/improved.service.ts": 75},
		"coverage_current": {"src/improved.service.ts": 85},
		"coverage_targets": {},
		"coverage_exemptions": [],
		"coverage_gaps": [],
		"coverage_history": {},
...
test_r17_minor_degradation_ok if {
	result := quality.warn with input as {
		"changed_files": [{"path": "src/minor.service.ts", "status": "modified"}],
		"coverage_baseline": {"src/minor.service.ts": 85},
		"coverage_current": {"src/minor.service.ts": 83},
		"coverage_targets": {},
		"coverage_exemptions": [],
		"coverage_gaps": [],
		"coverage_history": {},
