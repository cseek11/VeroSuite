...
import data.compliance.security.deny
import data.compliance.security.warn
...
test_auth_event_without_logging {
    mock_input := {
        "changed_files": [
            {
...
test_authz_event_without_logging {
    mock_input := {
        "changed_files": [
            {
...
test_pii_access_without_logging {
    mock_input := {
        "changed_files": [
            {
...
test_policy_change_without_logging {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/permissions/permissions.service.ts",
...
test_policy_change_with_logging {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/permissions/permissions.service.ts",
...
test_admin_action_without_logging {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/admin/admin.service.ts",
...
test_admin_action_with_logging {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/admin/admin.service.ts",
...
test_financial_transaction_without_logging {
    mock_input := {
        "changed_files": [
            {
...
test_financial_transaction_with_logging {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/payments/payments.service.ts",
...
test_metadata_only_audit_log {
    ...
    warnings := [msg | msg := warn[_]; contains(msg, "Raw PII")]
    count(warnings) == 0 with input as mock_input
}

# Test 15: Override marker bypasses violation
test_override_marker_bypasses_violation {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/auth/auth.service.ts",
...
test_multiple_security_events {
    ...
    count(deny) >= 2 with input as mock_input
}

# Test 17: SQL policy change without logging (violation)
test_sql_policy_change_without_logging {
    mock_input := {
        "changed_files": [
            {
    ...
    violation := [msg | msg := deny[_]; contains(msg, "Security policy change")][0]
    contains(violation, "not logged")
}

# Test 18: Password change without logging (violation)
test_password_change_without_logging {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/auth/auth.service.ts",
...
test_password_change_with_logging {
    mock_input := {
        "changed_files": [
            {
                "path": "apps/api/src/auth/auth.service.ts",
